...
Public Class Change_Class1_Batch
    ...
    Private Sub btn_OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_OK.Click
        If ListBox1.SelectedIndex = -1 Then
            MsgBox("必须选择一个分类")
        Else
            dialog_Change_Class_Batch.lbl_Class1.Text = ListBox1.Text
            Me.Close()
        End If
    End Sub
    ...
    Private Sub btn_Select_Class2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Select_Class2.Click
        If ListBox1.SelectedIndex = -1 Then
            MsgBox("必须先选择好分类一")
        Else
            btn_OK_Click(Nothing, Nothing)
            dialog_Change_Class_Batch.Button2_Click(Nothing, Nothing)
        End If
    End Sub

    Private Sub btn_new_Class1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_new_Class1.Click
        ...
        ElseIf ListBox1.Items.Contains(str_New_Class_Name) Then
            MsgBox("新分类名不可与已有的重复！")
            btn_new_Class1_Click(Nothing, Nothing)
    ...
    Private Sub class_form_Change_Class1_Batch_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Dim Sql As String = "Select Distinct 分类一 From 总目录 Order by 分类一 Asc"
