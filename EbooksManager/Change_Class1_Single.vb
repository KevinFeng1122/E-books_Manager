...
Public Class class_from_Select_Class1
    ...
    Overridable Sub btn_OK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_OK.Click
        If ListBox1.SelectedIndex = -1 Then
            MsgBox("必须选择一个分类")
        Else
            With form_Edit_Information.ComboBox_Class1.Items
                .Clear()
                .Add(ListBox1.Text)
                .Add("选择其它分类")
            End With
            form_Edit_Information.ComboBox_Class1.SelectedIndex = 0
            Me.Close()
        End If
    End Sub
    ...
    Overridable Sub btn_Select_Class2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Select_Class2.Click
        If ListBox1.SelectedIndex = -1 Then
            MsgBox("必须先选择好分类一")
        Else
            btn_OK_Click(Nothing, Nothing)
            form_Edit_Information.ComboBox_Class2.SelectedIndex = 1
        End If
    End Sub
End Class